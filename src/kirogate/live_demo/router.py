...
Exposes endpoints for running real AI agent scenarios through KiroGate.
"""
...
from kirogate.dashboard_api.router import record_audit_event, record_pipeline_event
from kirogate.live_demo.llm_provider import get_provider
from kirogate.live_demo.scenarios import run_scenario, ScenarioResult
from kirogate.live_demo.database import reset_database
...
SCENARIO_LIST = [
    ScenarioInfo(
        ...
        "KiroGate allows the SELECT and redacts sensitive fields.",
    ...
    ScenarioInfo(
        ...
        "KiroGate blocks — only SELECT is permitted.",
...
async def execute_scenario(
    ...
    The agent generates an intent, KiroGate evaluates it through
