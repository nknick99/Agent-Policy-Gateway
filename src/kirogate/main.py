"""KiroGate Proxy — FastAPI application with full enforcement pipeline.
...
from kirogate.auth_service import auth_router
from kirogate.dashboard_api import dashboard_router
from kirogate.live_demo.router import router as live_demo_router
...
async def lifespan(app: FastAPI):
    ...
    Checks KIROGATE_AGENT_TOKEN, loads policy.json, validates default="deny".
...
app = FastAPI(title="KiroGate Proxy", lifespan=lifespan)
