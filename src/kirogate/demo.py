"""KiroGate Demo Web UI.

A simple HTML dashboard that lets you interact with the KiroGate proxy
visually — send requests, see pipeline decisions, and explore the policy.

Run with:
    python -m uvicorn kirogate.demo:app --host 127.0.0.1 --port 8080 --app-dir src

Requires KIROGATE_AGENT_TOKEN to be set in environment.
"""
...
app = FastAPI(title="KiroGate Demo", lifespan=lifespan)
...
<title>KiroGate — Policy Gateway Demo</title>
<style>
...
<div class="container">
    <div class="header">
        <div>
            <h1>🛡️ KiroGate Policy Gateway</h1>
    ...
    <div class="grid">
        ...
        <div>
            <div class="card">
                ...
                <input type="text" id="token" value="" placeholder="Enter KIROGATE_AGENT_TOKEN value">
